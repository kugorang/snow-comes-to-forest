...
namespace Cinemachine
{
    ...
    public class CinemachineGroupComposer : CinemachineComposer
    {
        ...
        private float m_prevTargetHeight; // State for damping
        ...
        public override void MutateCameraState(ref CameraState curState, float deltaTime)
        {
            ...
            var currentOffset = TrackedPoint - curState.RawPosition;
            ...
            // Get the camera axis
            var fwd = currentOffset.AlmostZero() ? Vector3.forward : currentOffset.normalized;
            ...
            var targetPos = m_lastBoundsMatrix.MultiplyPoint3x4(m_LastBounds.center);
            ...
            if (!curState.Lens.Orthographic && m_AdjustmentMode != AdjustmentMode.ZoomOnly)
            {
                ...
                var currentFOV = curState.Lens.FieldOfView;
                var targetDistance = targetHeight / (2f * Mathf.Tan(currentFOV * Mathf.Deg2Rad / 2f));

                // target the near surface of the bounding box
                var cameraDistance = targetDistance + m_LastBounds.extents.z;
            ...
            {
                var nearBoundsDistance = (TrackedPoint - curState.CorrectedPosition).magnitude
