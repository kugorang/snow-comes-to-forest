...
namespace Cinemachine
{
    ...
    public struct CameraState
    {
        ...
        {
            get { return ReferenceLookAt == ReferenceLookAt; }
        } // will be false if NaN
        ...
        {
            get { return RawPosition + PositionCorrection; }
        }
        ...
        {
            get { return RawOrientation * OrientationCorrection; }
        }
        ...
        private int FindCustomBlendable(Object custom)
        {
            ...
            if (m_CustomOverflow != null)
                for (var i = 0; i < m_CustomOverflow.Count; ++i)
        ...
        public static CameraState Lerp(CameraState stateA, CameraState stateB, float t)
        {
            ...
            else
            {
                ...
                var angle = Quaternion.Angle(stateA.RawOrientation, stateB.RawOrientation);
            ...
            for (var i = 0; i < stateB.NumCustomBlendables; ++i)
            {
        ...
        private float InterpolateFOV(float fovA, float fovB, float dA, float dB, float t)
        {
            ...
            var hA = dA * 2f * Mathf.Tan(fovA * Mathf.Deg2Rad / 2f);
            var hB = dB * 2f * Mathf.Tan(fovB * Mathf.Deg2Rad / 2f);
            var h = Mathf.Lerp(hA, hB, t);
            var fov = 179f;
            var d = Mathf.Lerp(dA, dB, t);
