...
namespace Cinemachine.Utility
{
    internal static class SplineHelpers
    {
            ...
            ref Vector4[] knot, ref Vector4[] ctrl1, ref Vector4[] ctrl2)
        {
            ...
            var margin = Mathf.Min(4, numPoints - 1);
            var knotLooped = new Vector4[numPoints + 2 * margin];
            var ctrl1Looped = new Vector4[numPoints + 2 * margin];
            var ctrl2Looped = new Vector4[numPoints + 2 * margin];
