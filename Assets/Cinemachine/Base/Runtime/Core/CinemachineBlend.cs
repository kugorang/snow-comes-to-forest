...
namespace Cinemachine
{
    ...
    public class CinemachineBlend
    {
        ...
        {
            get { return TimeInBlend >= Duration; }
        }
        ...
        public string Description
        {
            get
            {
                var fromName = CamA != null ? "[" + CamA.Name + "]" : "(none)";
                var toName = CamB != null ? "[" + CamB.Name + "]" : "(none)";
                var percent = (int) (BlendWeight * 100f);
        ...
        {
            get { return CameraState.Lerp(CamA.State, CamB.State, BlendWeight); }
        }
        ...
        public AnimationCurve BlendCurve
        {
            get
            {
                ...
                switch (m_Style)
                {
                    ...
                    case Style.EaseIn:
                    {
                        var curve = AnimationCurve.Linear(0f, 0f, time, 1f);
                        var keys = curve.keys;
                        keys[1].inTangent = 0;
                        curve.keys = keys;
                        return curve;
