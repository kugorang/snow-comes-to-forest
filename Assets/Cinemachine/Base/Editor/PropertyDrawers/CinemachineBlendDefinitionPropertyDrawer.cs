...
namespace Cinemachine.Editor
{
    ...
    {
        private readonly CinemachineBlendDefinition
            myClass = new CinemachineBlendDefinition(); // to access name strings
        ...
        public override void OnGUI(Rect rect, SerializedProperty property, GUIContent label)
        {
            ...
            var timeText = new GUIContent(" sec ", timeProp.tooltip);
            ...
            if (styleProp.intValue != (int) CinemachineBlendDefinition.Style.Cut)
            {
                ...
                rect.x += rect.width;
                rect.width = floatFieldWidth + EditorGUIUtility.labelWidth;
