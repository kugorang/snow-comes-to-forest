...
namespace UnityEditor
{
    ...
    internal class RuleTileEditor : Editor
    {
        ...
        private void OnDrawElement(Rect rect, int index, bool isactive, bool isfocused)
        {
            ...
            var matrixRect = new Rect(rect.xMax - matrixWidth * 2f - 10f, yPos, matrixWidth, k_DefaultElementHeight);
        ...
        private static void RuleInspectorOnGUI(Rect rect, RuleTile.TilingRule tilingRule)
        {
            ...
            tilingRule.m_AutoTransform = (RuleTile.TilingRule.AutoTransform) EditorGUI.EnumPopup(
        ...
        {
            public readonly RuleTile.TilingRule.AutoTransform m_NewValue;
