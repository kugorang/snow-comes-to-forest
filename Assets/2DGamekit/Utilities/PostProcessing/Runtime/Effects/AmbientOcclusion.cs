...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    public sealed class AmbientOcclusion : PostProcessEffectSettings
    {
        ...
        [Range(-8f, -1f)] public FloatParameter blurTolerance = new FloatParameter {value = -4.6f}; // Hidden

        [ColorUsage(false)] [Tooltip("Custom color to use for the ambient occlusion.")]
        public ColorParameter color = new ColorParameter {value = Color.black};

        // HDRP-only parameters
        [Range(0f, 1f)] [Tooltip("")] public FloatParameter directLightingStrength = new FloatParameter {value = 0f};
        ...
        [Range(-8f, 0f)] public FloatParameter noiseFilterTolerance = new FloatParameter {value = 0f}; // Hidden
        ...
        [Range(-12f, -1f)] public FloatParameter upsampleTolerance = new FloatParameter {value = -12f}; // Hidden
