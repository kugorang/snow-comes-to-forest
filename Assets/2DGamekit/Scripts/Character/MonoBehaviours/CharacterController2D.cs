    ...
    public class CharacterController2D : MonoBehaviour
    {
        ...
        public void CheckCapsuleEndCollisions(bool bottom = true)
        {
            ...
            else
            {
                ...
                {
                    raycastDirection = Vector2.down;
                    var raycastStartBottomCentre = raycastStart + Vector2.down * (m_Capsule.size.y * 0.5f - m_Capsule.size.x * 0.5f);
                ...
                {
                    raycastDirection = Vector2.up;
                    var raycastStartTopCentre = raycastStart + Vector2.up * (m_Capsule.size.y * 0.5f - m_Capsule.size.x * 0.5f);
            ...
            {
                var count = Physics2D.Raycast(m_RaycastPositions[i], raycastDirection, m_ContactFilter, m_HitBuffer, raycastDistance);
                ...
                else
                {
                    ...
                    foreach (var t in m_HitBuffer)
                    {
                        ...
                        if (!PhysicsHelper.ColliderHasPlatformEffector(t.collider))
                        {
                            IsCeilinged = true;
                        }
                    }
