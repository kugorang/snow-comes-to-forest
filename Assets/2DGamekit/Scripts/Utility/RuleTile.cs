...
namespace UnityEngine
{
    ...
    public class RuleTile : TileBase
    {
                    ...
                    switch (rule.m_Output)
                    {
                        ...
                        case TilingRule.OutputSprite.Random:
                            var index = Mathf.Clamp(
                                Mathf.RoundToInt(Mathf.PerlinNoise((position.x + 1000000f) * rule.m_PerlinScale,
                                                     (position.y + 1000000f) * rule.m_PerlinScale) *
        ...
        public bool RuleMatches(TilingRule rule, Vector3Int position, ITilemap tilemap, ref Matrix4x4 transform)
        {
            ...
            for (var angle = 0;
                angle <= (rule.m_AutoTransform == TilingRule.AutoTransform.Rotated ? 270 : 0);
                angle += 90)
            ...
            if (rule.m_AutoTransform == TilingRule.AutoTransform.MirrorX &&
            ...
            if (rule.m_AutoTransform == TilingRule.AutoTransform.MirrorY &&
