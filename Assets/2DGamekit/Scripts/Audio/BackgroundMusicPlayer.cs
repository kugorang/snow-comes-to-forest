...
namespace Gamekit2D
{
    public class BackgroundMusicPlayer : MonoBehaviour
    {
        ...
        [Header("Ambient Settings")] public AudioClip ambientAudioClip;
        ...
        protected BackgroundMusicPlayer m_OldInstanceToDestroy;

        protected bool m_TransferMusicTime, m_TransferAmbientTime;

        [Header("Music Settings")] public AudioClip musicAudioClip;
        ...
        private void Awake()
        {
            ...
            if (Instance != null && Instance != this)
            {
                ...
                if (Instance.musicAudioClip == musicAudioClip) m_TransferMusicTime = true;

                //...if it use the same ambient clip, we set the audio source to be at the same position, so ambient don't restart
                if (Instance.ambientAudioClip == ambientAudioClip) m_TransferAmbientTime = true;
